  ...
  return (
    <section className="section-padding bg-white pb-32">
      <div className="max-w-6xl mx-auto px-6">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-brand-green to-brand-blue-dark py-16 md:py-24 px-8 md:px-16 text-center text-white shadow-2xl">
          {/* 장식용 애니메이션 배경 */}
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <h2 className="font-heading text-4xl md:text-6xl font-black mb-8 leading-[1.1] tracking-tighter">
              프로젝트를 현실로 <br /> 만들 준비가 되셨나요?
            </h2>

            <p className="text-white/80 text-lg md:text-xl leading-relaxed mb-12 max-w-2xl mx-auto font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                ...
                className="bg-white text-brand-green px-10 py-5 rounded-2xl font-black text-lg shadow-xl hover:scale-105 active:scale-95 transition-all duration-300"
              >
                톡톡 상담하기
              </a>
              <a
                href={`mailto:${COMPANY.email}`}
                className="border-2 border-white/30 bg-white/10 backdrop-blur-md text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-white/20 transition-all duration-300"
              >
